...
def sample_gaussian(m, v):
    ...
    # Sample z
    ################################################################################
    # See lecture 6, slide 15/26
    # Big picture: z is latent random variable. Can't do backprop on a random node
    # Make z deterministic by describing it by the parameters of its distribution
    # z = mean + std * eps, where eps is random noise N(0,I)
    # g(eps, phi) is now deterministic
    std = torch.sqrt(v)
